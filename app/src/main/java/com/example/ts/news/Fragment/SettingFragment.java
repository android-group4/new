...
public class SettingFragment extends Fragment implements View.OnClickListener {
    ...
    private void clearCache() {
        try {
            ...
            Toast.makeText(context, "本次清理" + cacheSize + "缓存( •̀ ω •́ )✧", Toast.LENGTH_SHORT).show();
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        switch (view.getId()) {
            case R.id.app_notice: {
                ...
                Notification notification = new Notification.Builder(getContext(), "channel_1")
                        .setContentTitle("您收到一条新通知(ง •_•)ง")
            ...
            case R.id.check_version: {
                Toast.makeText(getContext(), "当前已为最新版1.0(★ ω ★)", Toast.LENGTH_SHORT).show();
            }
            break;
            case R.id.about_app: {
